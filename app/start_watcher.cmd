@echo off
rem think-zh watcher launcher (multi-root, windowless via pythonw; log only)
chcp 65001 >nul
...
cd /d D:\think-zh\app
C:\Python314\pythonw.exe -X utf8 -u watcher_service.py >> D:\think-zh\app\watcher.log 2>&1
